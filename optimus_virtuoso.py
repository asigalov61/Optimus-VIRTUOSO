...
Original file is located at
    https://colab.research.google.com/drive/135OgLzlNBY-nCckDnigFtmzCtDS9fkQc

# Optimus VIRTUOSO (ver. 2.1)
...
creativity_temperature = 0.3 #@param {type:"slider", min:0.05, max:4, step:0.05}
