...
Original file is located at
    https://colab.research.google.com/drive/1-HFmP7_aYRbMK4D0_w6Sr4OR3kqgobAh

# Optimus VIRTUOSO (ver. 2.8)
...
#@title Download Named Synthetic Tegridy Piano MIDI dataset (recommended)

#@markdown Works best stand-alone/as-is for the optimal results
# %cd /content/Dataset/

!wget 'https://github.com/asigalov61/Tegridy-MIDI-Dataset/raw/master/Named-Synthetic-Tegridy-Piano-MIDI-Dataset-CC-BY-NC-SA.zip'
!unzip '/content/Dataset/Named-Synthetic-Tegridy-Piano-MIDI-Dataset-CC-BY-NC-SA.zip'
!rm '/content/Dataset/Named-Synthetic-Tegridy-Piano-MIDI-Dataset-CC-BY-NC-SA.zip'

# %cd /content/

# Commented out IPython magic to ensure Python compatibility.
#@title Download Named Tegridy Piano Transformer MIDI dataset (if you have the power)

#@markdown Works best stand-alone/as-is for the optimal results
# %cd /content/Dataset/

!wget 'https://github.com/asigalov61/Tegridy-MIDI-Dataset/raw/master/Named-Tegridy-Piano-Transformer-Dataset-CC-BY-NC-SA.zip'
!unzip 'Named-Tegridy-Piano-Transformer-Dataset-CC-BY-NC-SA.zip'
!rm '/content/Dataset/Named-Tegridy-Piano-Transformer-Dataset-CC-BY-NC-SA.zip'
...
creativity_temperature = 0.9 #@param {type:"slider", min:0.05, max:4, step:0.05}
top_k_prob = 48 #@param {type:"slider", min:0, max:128, step:1}
