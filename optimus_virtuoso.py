...
Original file is located at
    https://colab.research.google.com/drive/1uqCVskNXSHYIQUGIH9MxvgJkH6MFBnCf
...
Powered by tegridy-tools TMIDIX Optimus Processors with full multi-instrumental MuseNet text encoding: https://github.com/asigalov61/tegridy-tools
...
transform_to_pitch = 60 #@param {type:"slider", min:0, max:127, step:1}
...
TXT_String += 'CREATED_ON=' + str(datetime.now()) + chr(10)
...
output_list, song_name = TMIDIX.Tegridy_Optimus_TXT_to_Notes_Converter(completion, 
