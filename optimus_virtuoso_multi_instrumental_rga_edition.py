# -*- coding: utf-8 -*-
"""Optimus_VIRTUOSO_Multi_Instrumental_RGA_Edition.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zlTMTsNCLlRwZve1W4nBL4vH2OjOsGQ_
...
!wget 'https://github.com/asigalov61/Optimus-VIRTUOSO/raw/main/Dataset-Model/Relative-Global-Attention/Endless-Violin-Carousel/Optimus-VIRTUOSO-Trained-Model.zip.001'
!wget 'https://github.com/asigalov61/Optimus-VIRTUOSO/raw/main/Dataset-Model/Relative-Global-Attention/Endless-Violin-Carousel/Optimus-VIRTUOSO-Trained-Model.zip.002'
...
!unzip -j '/content/Dataset/Endless-Violin-Carousel-CC-BY-NC-SA.zip'
!rm '/content/Dataset/Endless-Violin-Carousel-CC-BY-NC-SA.zip'
...
for I in INTS_f:
  INTS_f1.extend([[0, 0, 0, 0, 0]]) # zero_token
  INTS_f1.extend(I)

train_data = []
for i in INTS_f1:
  if i[0] < TOKEN_END and i[1] < TOKEN_END:
      train_data.extend([i[0], i[1], i[2], i[3], i[4]])
...
if use_random_primer:
  ...
  try:
    if start_with_zero_token:
      rand_seq = model.generate(torch.Tensor([0, 0, 0, 0, 0, 10]), target_seq_length=number_of_tokens_to_generate)
      out = rand_seq[0].cpu().numpy().tolist()
    else:
...
if len(out) != 0:
  ...
  for s in song:
    ...
    song_f.append(['note', (abs(time)) * 10, (s[1]-char_offset) * 10, s[2]-char_offset, s[3]-char_offset, s[4]-char_offset ])
